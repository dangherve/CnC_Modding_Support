#!/bin/bash
set -e
git remote add upstream https://github.com/electronicarts/CnC_Modding_Support.git
git fetch upstream
git rebase upstream/main
git remote set-url origin git@github.com:dangherve/CnC_Modding_Support.git
